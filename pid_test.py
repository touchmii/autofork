...
class GoToGoalNode:
    ...
    def main(self):
        ...
        rospy.Subscriber('/aruco_tracker/pose', PoseStamped, self.on_posestamped)
        ...
        self.kA = rospy.get_param('~kA', 3.0)
        ...
        self.controller.set_max_angular_acceleration(
            rospy.get_param('~max_angular_acceleration', 0.05))
    ...
    def on_posestamped(self, newPose):
